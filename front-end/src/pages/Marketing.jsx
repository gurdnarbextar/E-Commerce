        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div className="mt-10">
              ...
              <a
                href="#"
                className="px-8 py-4 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-semibold text-lg hover:border-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-700"
              >
                Shop now →
              </a>
            </div>
